...
XLSX_PATH = PROJECT_ROOT / "master_mfcc_dataset.xlsx"
XLSX_SHEET = 1                           # Sheet index 1 = "מאגר נתונים מאוחד"
OUT_DIR_FIGS   = PROJECT_ROOT / "figures"
OUT_DIR_TABLES = PROJECT_ROOT / "tables"
...
print("\n" + "="*65)
print("  Step 1 COMPLETE - outputs saved to figures/ and tables/")
print("  Next: run  python Codes/02_spectrogram_analysis.py")
print("="*65 + "\n")
